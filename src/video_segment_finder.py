...
class VideoSegmentFinder:
    ...
    def __init__(self, threshold=30, min_change=20000):
    ...
    def __compare_frames__(self, prev_frame, cur_frame):
        # Crop the frames to only include the slide area
        # Adjust these numbers based on your specific video dimensions
        # Format is [y_start:y_end, x_start:x_end]
        prev_frame = prev_frame[0:500, 0:850]  # Adjusted to crop out right side thumbnails
        cur_frame = cur_frame[0:500, 0:850]    # Adjusted to crop out right side thumbnails
